...
<html lang="en">
	...
	<link rel="apple-touch-icon" sizes="57x57" href="http://localhost:8084/SetComerce/icon/apple-icon-57x57.png">
	<link rel="apple-touch-icon" sizes="60x60" href="http://localhost:8084/SetComerce/icon/apple-icon-60x60.png">
	<link rel="apple-touch-icon" sizes="72x72" href="http://localhost:8084/SetComerce/icon/apple-icon-72x72.png">
	<link rel="apple-touch-icon" sizes="76x76" href="http://localhost:8084/SetComerce/icon/apple-icon-76x76.png">
	<link rel="apple-touch-icon" sizes="114x114" href="http://localhost:8084/SetComerce/icon/apple-icon-114x114.png">
	<link rel="apple-touch-icon" sizes="120x120" href="http://localhost:8084/SetComerce/icon/apple-icon-120x120.png">
	<link rel="apple-touch-icon" sizes="144x144" href="http://localhost:8084/SetComerce/icon/apple-icon-144x144.png">
	<link rel="apple-touch-icon" sizes="152x152" href="http://localhost:8084/SetComerce/icon/apple-icon-152x152.png">
	<link rel="apple-touch-icon" sizes="180x180" href="http://localhost:8084/SetComerce/icon/apple-icon-180x180.png">
	<link rel="icon" type="image/png" sizes="192x192"  href="http://localhost:8084/SetComerce/icon/android-icon-192x192.png">
	<link rel="icon" type="image/png" sizes="32x32" href="http://localhost:8084/SetComerce/icon/favicon-32x32.png">
	<link rel="icon" type="image/png" sizes="96x96" href="http://localhost:8084/SetComerce/icon/favicon-96x96.png">
	<link rel="icon" type="image/png" sizes="16x16" href="http://localhost:8084/SetComerce/icon/favicon-16x16.png">
	
	<link rel="manifest" href="http://localhost:8084/SetComerce/icon/manifest.json">
	<meta name="msapplication-TileColor" content="#ffffff">
	<meta name="msapplication-TileImage" content="C:\Users\admi\Desktop\apple-icon-57x57.png">
	<meta name="theme-color" content="#ffffff">

        <link href='http://localhost:8084/SetComerce/CSS/font-awesome.min.css' rel='stylesheet' type='text/css'>
	<link href="http://localhost:8084/SetComerce/CSS/new1.css" rel="stylesheet">
        <link href='http://localhost:8084/SetComerce/CSS/bootstrap.min.css' rel='stylesheet' type='text/css'>
        <link href='http://localhost:8084/SetComerce/CSS/bootstrap-social.css' rel='stylesheet' type='text/css'>
        <link href='http://localhost:8084/SetComerce/CSS/new2.css' rel='stylesheet' type='text/css'>

        <script src="http://localhost:8084/SetComerce/CSS/jquery-3.2.1.min.js"></script>
        <script src="http://localhost:8084/SetComerce/CSS/bootstrap.min.js"></script>
	    </head>
    <body>
	<div class="header">
		<div class="navbar navbar-blue" role="navigation">
			...
			<a class="logo" href="https://epdf.pub/">
			    <img src="http://localhost:8084/SetComerce/icon/epdf_logo.png" style="max-height: 60px;"/>
			</a>
			...
			<ul class="nav navbar-nav">
			    <li class="active"><a href="http://localhost:8084/SetComerce/Home.jsp"><i class="fa fa-home"></i> Home</a></li>
			        			    <li><a href="http://localhost:8084/SetComerce/ADDbook.jsp"><i class="fa fa-plus"></i> Add Document</a></li>
    			    <li><a data-toggle="modal" data-target="#login"><i class="fa fa-sign-in"></i> Sign In</a></li>
    			    <li><a href="http://localhost:8084/SetComerce/PageRegister.html"><i class="fa fa-key"></i> Register</a></li>
			    			</ul>
...
<!-- ###################################################################################### -->
	...
	<div class="col-md-12 text-justify">
	    ...
	    <label><h2>Your Total Price is : ${TotalPrixPanier} &emsp;Dh<a href="http://localhost:8084/SetComerce/JSPpage/Payement.jsp"> &emsp;&emsp;&emsp;Bought</a></h2></label>	
	</div>
    </div>
</div>
...
<div class="container-fluid">
	           ...
	           <div class="col-lg-2 col-md-3 col-xs-6">
                  <div class="note">
	                <div class="note-meta-thumb">	
		             ...
		             <img src="http://localhost:8084/SetComerce/Images/<%=rs.getString(2).replaceAll(" ","-") %>.jpg" alt="Advanced Grammar in Use with Answers" />
		             <h3 class="note-title"><%=rs.getString(2).replaceAll("-"," ")%></h3>
	                </a>
	               </div>
	                   <div class="note-action">
	                     <a class="more-link" href="http://localhost:8084/SetComerce/HTMLpage/ThinkLikeAman.html">Read more</a>&emsp;&emsp;&emsp;&nbsp;
	                     <a href="Panier?idDelet=<%=rs.getString(1) %>">Delete</a>&emsp;<%=rs.getString(4) %> DH
	                   </div>
                   </div>
                 </div> 
 ...
 <!-- *************************************************************************************************************************** -->			
	...
	<script src="http://localhost:8084/SetComerce/CSS/jquery-ui.min.js"></script>
	<link rel="stylesheet" href="http://localhost:8084/SetComerce/CSS/jquery-ui.css">
	<script>
	    $(function () {
...
<script src="http://localhost:8084/SetComerce/CSS/jquery.bxslider.min.js"></script>
<script>
